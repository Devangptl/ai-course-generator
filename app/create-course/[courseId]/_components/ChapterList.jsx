...
const ChapterList = ({ course, refreshData, edit = true, loading }) => {
    return (
        <div className='mt-3'>
            ...
            <div className='m-2 '>
                {course?.courseOutput?.chapters.map((chapter, index) => (
                    <div key={index}>
                        {!loading?<div  className='flex items-center justify-between p-5 mb-2 border rounded-lg'>
                    ...
                    :
                    <div className='w-full rounded-lg bg-slate-200 mb-2 animate-pulse h-[100px]'>
